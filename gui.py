...
class AirconditionDock(QDockWidget):
    ...
    def __init__(self,mc):
        ...
        layout.addWidget(self.eLivingButton, 0, 0)
        layout.addWidget(self.eLivRoomTemp, 0, 1)
        layout.addWidget(self.eRoomgButton, 0, 2)
        layout.addWidget(self.eRoomTemp, 1, 0)
